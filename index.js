...
//        errors.push(name + ' is too short (min: ' + def.min + ')');
//      }
//    }
//    if (!_.isUndefined(def.max)) {
//      if (value && value.length > def.max) {
//        errors.push(name + ' is too long (max: ' + def.max + ')');
//      }
//    }
//    if (def.lowercase) {
//      if (value && _.isString(value)) {
...
//      case Date:
//        if (value && !_.isDate(value)) {
//          errors.push(name + ' is not a Date');
//        }
//        break;
//      case 'bool':
//      case 'boolean':
...
//          errors.push(name + ' is not a Boolean');
//        }
//        break;
//      case 'object':
//      case Object:
